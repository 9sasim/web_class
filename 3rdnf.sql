...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2022 at 06:07 AM
...
(1, 'Mridula Shrestha', 'Kirtipur,Dhalpa', 2),
(2, 'Soniya Shrestha', 'Kirtipur,Dhalpa', 3),
(3, 'Sudat Sasim Shrestha', 'Kirtipur,Dhalpa', 1);
...
--
ALTER TABLE `customer`
  ADD CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`Salutation`) REFERENCES `salutation` (`salutation_id`) ON UPDATE CASCADE;

--
-- Constraints for table `movie`
--
ALTER TABLE `movie`
  ADD CONSTRAINT `movie_ibfk_1` FOREIGN KEY (`Membership_id`) REFERENCES `customer` (`Membership_id`) ON UPDATE CASCADE;
COMMIT;
